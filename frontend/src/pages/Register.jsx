        ...
        <div className="text-center">
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 lg:-bottom-3 lg:-right-3 bg-green-500 rounded-full p-1.5 sm:p-2 lg:p-2.5 shadow-lg">
          ...
          <p className="text-gray-600 text-base sm:text-lg lg:text-xl">Create your account and start ordering</p>
        </div>
